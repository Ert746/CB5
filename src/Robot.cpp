...
#include <WPILib.h>// might consider not including full wpilib
...
class Robot: public frc::IterativeRobot {
	static void VisionThread(){// multithreading is required for the image proccessing so yah
		 ...
		 while(true){//image processing happens in here
				 ...
				 rectangle(cruncher, cv::Point(100, 100), cv::Point(400, 400),
				 					cv::Scalar(255, 255, 255), 5);//draw some rectangles on that thing WOOT RECTANGLES
